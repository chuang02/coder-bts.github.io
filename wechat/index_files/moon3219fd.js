...
var d,w,l,m,u,_,p,f=/MicroMessenger/i.test(navigator.userAgent),h=window.define,g=0,v=2,y=4,O=9,x=10;
...
var x=new Image,b="https://badjs.weixinbridge.com/badjs?id="+m+"&level=4&from="+encodeURIComponent(location.host)+"&msg="+encodeURIComponent(a);
...
var i=e.localStorage,a=document.head||document.getElementsByTagName("head")[0],s=1,c=11,d=window.__allowLoadResFromMp?1:2,w=window.__allowLoadResFromMp?1:0,l=d+w,m=window.__moon_host||"res.wx.qq.com",u=new RegExp("^(http(s)?:)?//"+m);
...
var d=1*i.getItem(p.prefix+"clean_time"),w=+new Date;
if(w-d>=1296e6){
p.clear();
try{
...
p.mod_num++,p.clearSample||!o||a!=version)p.unload.push(a.replace(u,""));else{
...
var o,t,n="",r=[],i={},a=-1!=location.search.indexOf("no_moon2=1"),s="//"+m;
