...
});define("a/a_report.js",["biz_wap/utils/ajax.js","biz_wap/jsapi/core.js","biz_wap/utils/mmversion.js"],function(t){
"use strict";
function o(t,o){
var e="https:"==top.location.protocol?1500:1200,s="/mp/advertisement_report?r="+Math.random()+"&",c=[],u=!1;
for(var _ in t)t.hasOwnProperty(_)&&c.push(_+"="+t[_]);
s+=c.join("&");
var l="trace_id="+t.tid+"&product_type="+t.pt+"&jump_url="+t.url+"&logtype=3&url="+encodeURIComponent(location.href)+"&rl="+t.rl;
t.tid&&p.gtVersion("6.3.22",!0)&&a.invoke("adDataReport",{
ad_info:l,
...
var r=t("biz_wap/utils/ajax.js"),i=window.__report,e=top.location.protocol,n="https:"==e?5:0,a=t("biz_wap/jsapi/core.js"),p=t("biz_wap/utils/mmversion.js");
return{
AdClickReport:o
};
